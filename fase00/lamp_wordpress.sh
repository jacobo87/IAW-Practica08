...
sed -i "/COLLATE/a define( 'WP_HOME', 'http://192.168.10.190' );" /var/www/html/wordpress/wp-config.php
sed -i "/COLLATE/a define( 'WP_SITEURL', 'http://192.168.10.190/wordpress');" /var/www/html/wordpress/wp-config.php
